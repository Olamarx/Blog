...
RSpec.describe 'Users', type: :feature do
  context 'user index page' do
    before(:each) do
      @name = 'Ola'
      @user = User.create(name: @name, bio: 'Teacher from Poland.', photo: 'https://github.com/masangana/blog/blob/ff0fc0a1396204b7be88769e650aa1a3dfee29b4/app/assets/images/2.jpg')
      @user.save
    end
